...
import {
  ...
  ROUTE_AUTHOR_CREATE,
  ROUTE_AUTHOR_EDIT,
  ROUTE_ARTICLE_VIEW_EACH_RECORD,
} from '../../constants';
...
import ArticleViewEach from '../../pages/ArticleViewEach/ArticleViewEach';
    ...
    <div className="MainContent mt-3">
      <Container>
        <Switch>
          ...
          <Route path={ROUTE_ARTICLE_VIEW_EACH_RECORD}>
            <ArticleViewEach />
          </Route>
